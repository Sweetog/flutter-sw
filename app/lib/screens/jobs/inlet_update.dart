...
class JobInletUpdate extends StatefulWidget {
  final String _jobId;
  final int editIndex;

  JobInletUpdate(this._jobId, this.editIndex);

  @override
  _JobInletUpdateState createState() =>
      _JobInletUpdateState(this._jobId, this.editIndex);
}

class _JobInletUpdateState extends State<JobInletUpdate> {
